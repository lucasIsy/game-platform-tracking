import dlt as dp
from pyspark.sql.types import StructType, StructField, StringType, LongType, TimestampType, BooleanType, ArrayType
...
@dp.table(
    name="bronze_twitch",
    comment="Ingestão bruta incremental dos dados da Twitch via Auto Loader",
...
def bronze_twitch():
    return (
        ...
        .load("/Volumes/workspace/default/my_volume/testes/parquet/twitch")
    )